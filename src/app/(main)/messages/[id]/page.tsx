...
export default function ConversationPage() {
  ...
  if (error) {
    return (
      <div className="min-h-dvh bg-white flex flex-col items-center justify-center p-6">
        ...
        <button onClick={loadData} className="px-4 py-2 bg-[#003898] text-white rounded">Retry</button>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      {/* Header */}
      <header className="px-4 pt-4 pb-4 border-b border-slate-100 flex items-center justify-between sticky top-0 bg-white z-20">
        ...
        <div className="px-4 py-3 bg-slate-50 border-b border-slate-100">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="px-4 py-2 bg-[#003898] text-white text-sm font-medium rounded-lg transition-colors shadow-sm"
            >
              Verify Now
            </button>
          </div>
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 scroll-smooth">
        {messages.length > 0 && (
          <div className="flex justify-center mb-6">
            <span className="px-4 py-1.5 bg-slate-50 border border-slate-100 rounded-full text-xs font-medium text-slate-500">
        ...
        <div className="space-y-4 pb-4">
          ...
          {messages.map((msg) => {
            ...
            return (
              ...
              >
                {!isMine && conversation && (
                  <div className="w-8 h-8 bg-slate-50 rounded-full flex items-center justify-center shrink-0 overflow-hidden border border-slate-100">
